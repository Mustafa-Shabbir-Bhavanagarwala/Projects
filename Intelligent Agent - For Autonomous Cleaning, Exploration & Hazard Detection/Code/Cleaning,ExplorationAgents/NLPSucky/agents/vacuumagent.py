...
from agents.vacuumenvironment import ACTION_SUCK, ACTION_UNSUCK
from agents.vacuumenvironment import ACTION_SENSE_GOLD, ACTION_MINE_GOLD, ACTION_UNLOAD_GOLD
from agents.vacuumenvironment import ACTION_NOP, ACTION_STOP
