...
The aabove dataframe has filtering taking place where mutate takes place between 0 and 9.26 Here N is lesser than 10 power of 4-1
Observdg is equal to mean( maindataframe where departuer delay is of main dataframe and vvisiblenwe is equal to zero where na.rm is equla to true. Minus mean of maindatfrakm where dep delay)